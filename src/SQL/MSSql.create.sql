...
CREATE TABLE [AnimalHome] (
	 ...
	 [Animal_m0] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [Animal] (
	 ...
	 [AnimalType_m0] UNIQUEIDENTIFIER  NULL,
...
CREATE TABLE [ApplicationLog] (
 ...
 ALTER TABLE [AnimalHome] ADD CONSTRAINT [AnimalHome_FAnimal_0] FOREIGN KEY ([Animal_m0]) REFERENCES [Animal]
CREATE INDEX AnimalHome_IAnimal_m0 on [AnimalHome] ([Animal_m0])

 ALTER TABLE [Animal] ADD CONSTRAINT [Animal_FAnimalType_0] FOREIGN KEY ([AnimalType_m0]) REFERENCES [AnimalType]
CREATE INDEX Animal_IAnimalType_m0 on [Animal] ([AnimalType_m0])
